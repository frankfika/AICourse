                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '推荐阅读：AI 简史', url: 'https://example.com/ai-history.pdf', type: 'pdf' },
                                            { title: '相关论文集合', url: 'https://example.com/papers', type: 'link' },
                                        ],
                                    },
                                },
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: 'Transformer 架构图解', url: 'https://example.com/transformer.pdf', type: 'pdf' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '提示词模板库', url: 'https://example.com/prompts.pdf', type: 'pdf' },
                                            { title: '示例代码仓库', url: 'https://github.com/example/ai-prompts', type: 'code' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: 'HTML 速查表', url: 'https://example.com/html-cheatsheet.pdf', type: 'pdf' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '示例 CSS 代码', url: 'https://github.com/example/css-samples', type: 'code' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: 'Python 语法速查', url: 'https://example.com/python-cheatsheet.pdf', type: 'pdf' },
                                            { title: '示例代码', url: 'https://github.com/example/python-basics', type: 'code' },
                                        ],
                                    },
                                },
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '课后习题', url: 'https://example.com/exercises.pdf', type: 'pdf' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '函数练习集', url: 'https://github.com/example/python-functions', type: 'code' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '常用命令速查', url: 'https://example.com/linux-commands.pdf', type: 'pdf' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '漏洞演示代码', url: 'https://github.com/example/sqli-demo', type: 'code' },
                                            { title: 'OWASP 漏洞清单', url: 'https://owasp.org/www-project-top-ten/', type: 'link' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: '云服务对比表', url: 'https://example.com/cloud-comparison.pdf', type: 'pdf' },
                                        ],
                                    },
                                },
                            ],
                            ...
                            create: [
                                {
                                    ...
                                    resources: {
                                        create: [
                                            { title: 'Docker 命令清单', url: 'https://example.com/docker-commands.pdf', type: 'pdf' },
                                            { title: '示例 Dockerfile', url: 'https://github.com/example/docker-samples', type: 'code' },
                                        ],
                                    },
                                },
                            ],
