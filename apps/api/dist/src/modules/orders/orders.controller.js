...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: '创建订单（免费商品会直接注册）' }),
    __param(0, (0, common_1.Request)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mock 支付（标记为已支付并完成注册）' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, orders_dto_1.MockPayDto]),
    __metadata("design:returntype", Promise)
], OrdersController.prototype, "pay", null);
__decorate([
    (0, common_1.Post)(':id/cancel'),
    (0, swagger_1.ApiOperation)({ summary: '取消未支付订单' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
