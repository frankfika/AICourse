...
exports.HackathonsModule = HackathonsModule = __decorate([
    (0, common_1.Module)({
        controllers: [hackathons_controller_1.HackathonsController],
        providers: [hackathons_service_1.HackathonsService],
        exports: [hackathons_service_1.HackathonsService],
    })
], HackathonsModule);
