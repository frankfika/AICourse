...
const AdminAiPage = lazy(() => import('./features/admin/AdminAiPage').then(m => ({ default: m.AdminAiPage })));
...
export const router = createBrowserRouter([
    ...
    children: [
      ...
      { path: 'profile', element: <AuthGuard><PublicSuspense><ProfilePage /></PublicSuspense></AuthGuard> },
      {
        ...
        children: [
          ...
          { path: 'ai', element: <PublicSuspense><AdminAiPage /></PublicSuspense> },
  ...
  { path: '/auth/reset', element: <PublicSuspense><ResetPasswordPage /></PublicSuspense> },
