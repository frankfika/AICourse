...
export const PAGE_FALLBACK: Record<string, Record<string, any>> = {
  ...
  dashboard: {
    ...
    ai: {
      not_ready_label: { 'zh-CN': 'AI 助教已连接', 'en-US': 'AI Tutor connected' },
...
export const I18N_FALLBACK: Record<string, string> = {
  ...
  'dashboard.ai.placeholder': '基于当前课程内容提问，AI 助教会结合学习上下文回答。',
  ...
  'dashboard.outline.progress.detail': '共 {total} 个模块 · {completed} / {total} 课时已完成',
  'dashboard.notes.placeholder.label': '笔记会保存到你的学习账号，可随时继续编辑',
